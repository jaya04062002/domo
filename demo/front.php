...
$mail->Username = 'jayasreevcm23@gmail.com';          // SMTP username
$mail->Password = 'hfcztpteeycjgroi'; // SMTP password
$mail->SMTPSecure = 'tls';                  // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                          // TCP port to connect to
$mail->setFrom('jayasreevcm23@gmail.com', 'jayareee');
$mail->addReplyTo('jayasreevcm23@gmail.com');
